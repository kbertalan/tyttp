...
hToPublisher : Applicative m
  ...
  -> ( step : Step Method h1 (TyTTP.HTTP.bodyOf {error = e} {monad = m}) h2 a ((TyTTP.HTTP.bodyOf {error = e} {monad = m}) me a) )
  -> m $ Step Method h1 (TyTTP.HTTP.bodyOf {error = e} {monad = m}) h2 a (Publisher m e a)
hToPublisher = \s =>
